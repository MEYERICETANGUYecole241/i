...
export default function Our_rooms() {
  return (
   <div>
      ...
      <section className="px-6 py-6 bg-white">
        <div className="flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="w-full md:w-2/3">
            <img src="chambres.svg" alt="Room" className="w-full h-auto object-cover" />
          </div>
          
          {/* Texte à droite – occupe 1/3 de l’espace */}
          <div className="w-full md:w-1/3 text-right">
            <h2 className="text-3xl font-bold text-gray-900 mb-4 text-center">PIECE OF MINDS</h2>
